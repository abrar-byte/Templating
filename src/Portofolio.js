  ...
  render() {
    return (
      <div className="section-1">
        ...
        <div className="main">
          <Navbar>
            <Navbar.Brand href="#logo" className="nb">

              <img height="43" width="43" src="./logo (1).png" />
            </Navbar.Brand >
            ...
            <Navbar.Collapse className="justify-content-end">
              ...
              <Nav.Link className="text-nav" href="#work">Work</Nav.Link>
              <Nav.Link className="text-nav" href="about">About</Nav.Link>
            </Navbar.Collapse>
          ...
          <Row >
            <Col >
              <Container className="margin">
                <img width="200" src="./Group 5.1.png" className="center" />
      ...
      <div className="section-3" style={{ height: 950 }}>
        <Container fluid>
          <Row>
            <Col >
              <Container className="margin">
                <img width="700" src="./ebcMockup.png" />
              </Container>
            </Col>
            <Col>
              <img width="400" src="./ebcLogo.png" className="center" />
      ...
      <div className="section-4" style={{ height: 950 }}>
        <Container fluid >
          <Row>
            <Col>
              <Container className="margin">
                <img width="100" src="./rwlogo.png" className="center" />
        ...
        <Container fluid >
          <Row>
            <Col>
              ...
              <img className="center" width="200" src="./Icons.png" />
